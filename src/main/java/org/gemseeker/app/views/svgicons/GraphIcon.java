 ...
 * @author gemini1991
 */
public class GraphIcon extends SVGIcon {

    public GraphIcon() {
        super();
    }
    
    public GraphIcon(double size) {
    ...
    protected SVGPath createIcon() {
        ...
        path.setContent("M33,362.371v78.9c0,4.8,3.9,8.8,8.8,8.8h61c4.8,0,8.8-3.9,8.8-8.8v-138.8l-44.3,44.3\n" +
"			C57.9,356.071,45.9,361.471,33,362.371z "
                + "M142,301.471v139.8c0,4.8,3.9,8.8,8.8,8.8h61c4.8,0,8.8-3.9,8.8-8.8v-82.3c-13.9-0.3-26.9-5.8-36.7-15.6L142,301.471z "
                + "M251,350.271v91c0,4.8,3.9,8.8,8.8,8.8h61c4.8,0,8.8-3.9,8.8-8.8v-167.9l-69.9,69.9\n" +
"			C257,345.971,254.1,348.271,251,350.271z "
                + "M432.7,170.171l-72.7,72.7v198.4c0,4.8,3.9,8.8,8.8,8.8h61c4.8,0,8.8-3.9,8.8-8.8v-265.6c-2-1.7-3.5-3.2-4.6-4.2\n" +
"			L432.7,170.171z "
                + "M482.6,41.371c-2.9-3.1-7.3-4.7-12.9-4.7c-0.5,0-1.1,0-1.6,0c-28.4,1.3-56.7,2.7-85.1,4c-3.8,0.2-9,0.4-13.1,4.5\n" +
